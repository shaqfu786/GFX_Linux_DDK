...
IMG_INTERNAL UCH_UseCodeHeap * UCH_CodeHeapCreate(PVRSRV_DEV_DATA*	ps3DDevData, UCH_CodeHeapType eType,
												  IMG_HANDLE hHeapAllocator, PVRSRV_MUTEX_HANDLE hSharedLock)
{
														 ...
														 IMG_UINT32			ui32Size)
{
	...
	*/
	...
	else
	{
		...
		*/
		psBestBlock = UCH_CodeHeapAllocateFunc(psHeap, ui32Size);	/* PRQA S 3670 */ /* Override QAC suggestion and use this recursive call. */
...
/***********************************************************************************
 ...
 Inputs             : psHeap, ui32Size, pszFileName, ui32Line
 Outputs            : -
...
IMG_INTERNAL UCH_UseCodeBlock * UCH_TrackCodeHeapAllocate(UCH_UseCodeHeap *psHeap, IMG_UINT32 ui32Size, 
													   const IMG_CHAR *pszFileName, IMG_UINT32 ui32Line)
{
	UCH_UseCodeBlock *psBlock = UCH_CodeHeapAllocateFunc(psHeap, ui32Size);
