...
UCH_UseCodeBlock *UCH_CodeHeapAllocateFunc(UCH_UseCodeHeap *psHeap, IMG_UINT32 ui32Size);
...
/* IMPORTANT: To allocate and free code blocks, use always the macros CodeHeapAllocate and CodeHeapFree */
	...
	#define UCH_CodeHeapAllocate(psHeap, ui32Size) UCH_TrackCodeHeapAllocate(psHeap, ui32Size, __FILE__, __LINE__)
