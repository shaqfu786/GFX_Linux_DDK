...
$$(eval $$(call TunableUserConfigMake,$(1),$(2)))
endef
...
$$(eval $$(call TunableUserConfigC,$(1),$(2)))
endef
...
ifeq ($(SGXCORE),535)
PVR2D_ALT_2DHW ?= 0
$(eval $(call UserConfigC,SUPPORT_SGX_COMPLEX_GEOMETRY,))
endif
...
#
$(eval $(call TunableUserConfigMake,COMPONENTS,))
$(eval $(call TunableUserConfigMake,OPK_COMPONENTS,))
$(eval $(call TunableUserConfigMake,LIBGCC,))
$(eval $(call TunableUserConfigMake,SYS_CFLAGS,))
$(eval $(call TunableUserConfigMake,SYS_CXXFLAGS,$(SYS_CFLAGS)))
$(eval $(call TunableUserConfigMake,SYS_EXE_CRTBEGIN,))
$(eval $(call TunableUserConfigMake,SYS_EXE_CRTEND,))
$(eval $(call TunableUserConfigMake,SYS_EXE_LDFLAGS,))
$(eval $(call TunableUserConfigMake,SYS_LIB_CRTBEGIN,))
$(eval $(call TunableUserConfigMake,SYS_LIB_CRTEND,))
$(eval $(call TunableUserConfigMake,SYS_LIB_LDFLAGS,))
$(eval $(call TunableUserConfigMake,TOOLCHAIN,))
$(eval $(call TunableUserConfigMake,LINKER_RPATH,))
$(eval $(call TunableUserConfigMake,SHLIB_DESTDIR,/usr/lib))
$(eval $(call TunableUserConfigMake,DEMO_DESTDIR,/usr/local/bin))
$(eval $(call TunableUserConfigMake,HEADER_DESTDIR,/usr/include))
$(eval $(call TunableUserConfigMake,EGL_DESTDIR,/usr/lib))
...
$(eval $(call TunableUserConfigMake,SGXCORE,))
...
$(eval $(call TunableUserConfigMake,SUPPORT_SGX,1))
$(eval $(call TunableUserConfigMake,SGX_CORE_REV,))
...
$(eval $(call UserConfigC,_XOPEN_SOURCE,600))
$(eval $(call UserConfigC,_POSIX_C_SOURCE,199309))
...
$(eval $(call UserConfigC,FFGEN_UNIFLEX,))
$(eval $(call UserConfigC,SUPPORT_OPENCL,))
...
$(eval $(call TunableUserConfigC,SGX_SUPPORT_VDM_TIMER_BASED_SWITCHING,))
$(eval $(call TunableUserConfigC,SGX_SUPPORT_ISP_TIMER_BASED_SWITCHING,))
$(eval $(call TunableUserConfigC,DBGBREAK_ON_SPM,))
...
$(eval $(call TunableUserConfigC,SUPPORT_SGX_UKERNEL_DCU_BYPASS,))
...
$(eval $(call TunableUserConfigC,PVR2D_ALT_2DHW,1))
$(eval $(call TunableUserConfigC,PVR2D_VALIDATE_INPUT_PARAMS,1))
$(eval $(call TunableUserConfigC,SUPPORT_OPENGLES1,1))
$(eval $(call TunableUserConfigC,SUPPORT_OPENGLES2,1))
$(eval $(call TunableUserConfigC,SUPPORT_OPENGLES1_V1_ONLY,))
$(eval $(call TunableUserConfigC,SUPPORT_OPENVG,1))
$(eval $(call TunableUserConfigC,SUPPORT_OPENGL,1))
$(eval $(call TunableUserConfigC,SUPPORT_OPENCL_11,))
$(eval $(call TunableUserConfigC,SUPPORT_SOURCE_SHADER,1))
$(eval $(call TunableUserConfigC,SUPPORT_BINARY_SHADER,1))
$(eval $(call TunableUserConfigC,CLIENT_DRIVER_DEFAULT_WAIT_RETRIES,))
$(eval $(call TunableUserConfigC,API_MODULES_RUNTIME_CHECKED,1))
$(eval $(call TunableUserConfigC,PVRSRV_CLIENT_RESET_ON_HWTIMEOUT,))
$(eval $(call TunableUserConfigC,DISABLE_SGX_PB_GROW_SHRINK,))
$(eval $(call TunableUserConfigC,EGL_DEFAULT_PARAMETER_BUFFER_SIZE,))
$(eval $(call TunableUserConfigC,EGL_EXTENSION_ANDROID_RECORDABLE,))
$(eval $(call TunableUserConfigC,EGL_EXTENSION_ANDROID_BLOB_CACHE,))
$(eval $(call TunableUserConfigC,GLES1_EXTENSION_EGL_IMAGE_EXTERNAL,))
$(eval $(call TunableUserConfigC,GLES2_EXTENSION_EGL_IMAGE_EXTERNAL,))

$(eval $(call TunableBothConfigMake,LDM_PLATFORM,))
$(eval $(call TunableBothConfigMake,LDM_PCI,))

$(eval $(call TunableUserConfigMake,EGL_EXTENSION_ANDROID_BLOB_CACHE,))
$(eval $(call TunableUserConfigMake,SUPPORT_SGX_HWPERF,1))
$(eval $(call TunableUserConfigMake,SGX_FEATURE_MP,))
$(eval $(call TunableUserConfigMake,SUPPORT_OPENGLES1_V1_ONLY,))
$(eval $(call TunableUserConfigMake,SUPPORT_OPENCL_11,))
$(eval $(call TunableUserConfigMake,SUPPORT_NV12_FROM_2_HWADDRS,))
$(eval $(call TunableUserConfigMake,PDUMP,))

$(eval $(call TunableBothConfigMake,OPTIM,))

$(eval $(call TunableUserConfigMake,IMGTCL_TCL_PREFIX,/usr/local/tcl8.4))
