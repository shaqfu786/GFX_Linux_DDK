...
bad_enum:
	...
	*/
	...
	{
		GLES2Free(gc, (IMG_VOID *)((IMG_UINTPTR_T)pui16Elements));
	}
...
bad_value:
	...
	*/
	...
	if(bIndicesWerePromoted) 
	{
		for(i = 0; i < ui32ActualPrimCount; i++)
		{
			GLES2Free(gc, (IMG_VOID *)((IMG_UINTPTR_T)(ppvElements[i])));
		}
	}
...
StopTimerAndReturn:
	...
	if(ppvElements)
	{
		GLES2Free(gc, (IMG_VOID*)((IMG_UINTPTR_T)ppvElements));		
	}
	if(ppvActualIndices)
	{
		GLES2Free(gc, (IMG_VOID*) ppvActualIndices);		
	}
	if(pui32ActualCount)
	{
		GLES2Free(gc, pui32ActualCount);	
